...
import static com.csc445.jrvv.pthree.SWINGputPiecesOnBoard.port;
import static com.csc445.jrvv.pthree.UserInterface.host;
import static com.csc445.jrvv.pthree.UserInterface.player1;
import static com.csc445.jrvv.pthree.UserInterface.player2;
import static com.csc445.jrvv.pthree.UserInterface.updateBoard;
...
public class SWINGactualBoard extends javax.swing.JFrame {
    ...
    UserInterface localUser = new UserInterface("", "");
...
try {
    ...
    //poop
    public void setLocationsOfPiece(ArrayList<String> LocationGreen, ArrayList<String> LocationBlue, ArrayList<String> LocationYellow, ArrayList<String> LocationPink, ArrayList<String> LocationOrange, UserInterface thisUser) {
        ...
        for (int i = 0; i < LocationYellowLocal.size(); i++) { //for the array containing location of green squares
            for (int j = 0; j < allButtons.size(); j++) { //check if it is a button
                ...
                if (LocationYellowLocal.get(i).equals(temp)) { //if a3 is contained in allButtons, should always be true
        ...
        for (int i = 0; i < LocationOrangeLocal.size(); i++) { //for the array containing location of green squares
            for (int j = 0; j < allButtons.size(); j++) { //check if it is a button
                ...
                if (LocationOrangeLocal.get(i).equals(temp)) { //if a3 is contained in allButtons, should always be true
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SWINGactualBoard.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
